...
This website is designed to inform users living in and around the Newmarket area of the Newmarket Youth Baseball Team. The website is designed to inform users of the practice and map details. It also should explain kit requirements and fees, as well as inform the user of where practices take place. There is no skill level requirement to join the team, so the website is designed to include all skill levels.

![am-i-responsive-NYB](assets/images/readme/amIResponsiceScreenShotOptimized.png)
***

## Mockup
Before starting the website in github, the website was first mocked up in Wireframes. This ensured that there was a structure to refer to and structure mock up of the different screen sizes could be created. 
...
You will see the basic layout and content has been used. Along the way, there were changes made.

### Removals
I removed and replaced the Seasons games section. As the purpose of the website is to encourage players of all skill levels to join the team, I decided to include a recourse in the format of a video. This video explained th rules of the game. This became a stronger element for the purpose of the website at this time. 
...
I also removed the Home button the in the navigation bar. As the website is one streamlined page, it was a waste of navigation space. The logo directs to the top of the page. 

### Edits
The layout of the form is a litle different to the wireframe. 

In the footer of the website, I moved the reserved text to be placed underneath the social media links. This created consistency within the footer.  An addiitonal social media link was also added.

### Additions
Subheadings were added to all  sections to enhance user readability of the website and to create a stronger flow of the website. It gives each section of the page more purpose to the user. 

### Colours
Adobe color was used to find a colour pallet that would work for website. The sharp colours were chosed to represent the youthfulness of the players and the sport focus of the team.
...
## Features
The website includes a variety of features both interactive (navigation, video, form,links) and stagnent (text and images). 

### Navigation bar
The navigation bar sticks to the top of the page no matter how far down you scroll so the user is always able to access different sections of the page.
...
Images have been included to create a more attractive feature to the about section.

![about-club-2](/assets/images/readme/nyb-about-us-2.png)

### Baseball Rules
The club is for players of all skill levels. It became apparent that there needed to be recourses available for new members who may need to understnad the rules for the first time, or for participating members to have a refresher. 
...
### Join the Team
The form created is designed to gain information from the user of new team members. The basic contact information is requested. The users address information was relavant as this is a local team. The form was designed to be inviting and clear.
...
### Future features
As the website develops, a section on the seasons matches could be implimented. This would inform the user of matches of the seaon. A table could be featured including the date, the opposition team and the outcoming winner.
A gallery could be an additional feature to the website inclusive of team photos in a gallery wall or slideshow.
***
...
The sizings of different sections of the page changes as the screen size is decreased and increased. This is to ensure user readability as well as boost the asthetic of the page. The site has been tested on different mobile and tablet formats within the inspection section of the page. 

The website has also been tested on safari and chrome. 

Within the testing phase, changes had to be made to the navigation height when the screen is smaller. The hero image text box also needed re-positioning after initial and secondary tests. The box was oriignally overlapping different sections of the page and was clearly in the incorrect place.  This has since been amended and now is in the correct placement on all screen widths.
